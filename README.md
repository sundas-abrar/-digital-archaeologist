...
the story \u2014 with every claim traceable back to a specific file.
...
└── frontend/   Next.js \u2014 upload flow, dashboard (Overview, Investigation,
                Timeline, Code Evolution, Findings, Testing/QA, Files,
                Help Us Improve)
```
